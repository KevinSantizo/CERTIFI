      ...
      <v-card class="mb-3" max-width="100%">
        <div class="row no-gutters">
          <div class="col-md-4 pa-3" >
            <v-img class="text-left " src="https://futecastoresite.files.wordpress.com/2017/02/futecaportadaapp.jpg" height="200" style="border-radius: 10px;">
              <v-icon color="white" size="25" class="ma-2">mdi-bookmark-outline</v-icon> 
            </v-img>
            <v-card-actions>
...
export default {
  data: () => ({
        ...
        cards: [
        { title: 'Futeca Xela', src: 'https://futecastoresite.files.wordpress.com/2017/02/futecaportadaapp.jpg',},
      ],
      times: [
        '12:00 PM',
        '1:00 PM',
    ...
    methods: {
       getFields() {
      const path = 'http://192.168.8.105:8000/sport/fields/'
