<template>
  <v-container class="container">
    <v-card class="transparent">
      ...
      <div style="top: 1em;">
    <v-sheet  elevation="8" max-width="100%" color="transparent">
      <v-slide-group
        v-model="model"
        class="ma-1">
